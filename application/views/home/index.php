...
<section id="content">
    <?php $hero_img = site_option('hero_image', ''); ?>
    <div class="banner large text-center wow fadeInUp"
        <?= $hero_img ? 'style="background-image: url(' . htmlspecialchars($hero_img) . ')"' : '' ?>>
        <div class="container">
            <div class="row">
    ...
    <div class="our-facility with-bg-image"
        style="background-image: url('<?= base_url("assets/img/our-facility-bg.jpg") ?>')">
        <div class="container">
            <div class="row">
                <div class="facility-item col-md-3 text-center wow fadeIn">
                    <div class="counter-number">
                        <h2 class="counter"><?= (int) site_option('stat_staff', 24) ?></h2>
                    </div>
                ...
                <div class="facility-item col-md-3 text-center wow fadeIn">
                    <div class="counter-number">
                        <h2 class="counter"><?= (int) site_option('stat_students', 80) ?></h2>
                    </div>
                ...
                <div class="facility-item col-md-3 text-center wow fadeIn">
                    <div class="counter-number">
                        <h2 class="counter"><?= (int) site_option('stat_classes', 8) ?></h2>
                    </div>
                ...
                <div class="facility-item col-md-3 text-center wow fadeIn">
                    <div class="counter-number">
                        <h2 class="counter"><?= (int) site_option('stat_labs', 4) ?></h2>
                    </div>
