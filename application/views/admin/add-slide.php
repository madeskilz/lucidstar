    ...
    <div class="ll">
        <div class="container">
            ...
            <div class="col-md-4">
                ...
                <h3>Add Slide</h3>
                <img id="previewImg" style="margin-top:10px;width:80%;height:auto;" />
                <div class="form-group">
                    <label for="image">Slide Image</label>
                    <input type="file" accept="image/*" onchange="loadname(this,'previewImg')" name="image" id="image" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="body" id="body" class="form-control" required rows="5"></textarea>
                </div>
